...
const icons = {
  ...
  portrait: '<circle cx="12" cy="8" r="3.2"/><path d="M5.3 20c.8-4 3.1-6 6.7-6s5.9 2 6.7 6"/>',
  guide: '<path d="M5 4.5h8a3 3 0 0 1 3 3v12H8a3 3 0 0 0-3 1.5V4.5Z"/><path d="M16 7.5h3v13.5a3 3 0 0 0-3-1.5h-8M8.5 9h4.5M8.5 13h4.5"/>',
};
