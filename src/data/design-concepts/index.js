...
const patientConcepts = [
  ...
  },
  {
    ...
    subheadline: 'Tired mornings, snoring, and brain fog can have many causes. Together, they can be worth discussing.',
    hero: '/assets/images/hero-v1.jpg', designSystem: 'quiet-signal',
    recognitionTitle: 'Do any of these sound familiar?',
    recognitionIntro: 'A symptom is not a diagnosis. Several patterns together can be useful to discuss.',
    ...
    guidance: {
      reasons: {
        eyebrow: 'Why discuss the pattern', title: 'Restful sleep is more than time in bed.',
        copy: 'Nighttime breathing changes can leave sleep less restorative. You may notice low energy, brain fog, or a partner’s observations.',
        cards: [
          ['During sleep', 'Snoring, gasping, pauses, or restlessness.'],
          ['In the morning', 'Tiredness, dry mouth, or a headache.'],
          ['Through the day', 'Sleepiness, low energy, or trouble focusing.'],
        ],
      },
      appliance: {
        eyebrow: 'From symptoms to a treatment conversation', title: 'Could an oral appliance be part of the conversation?',
        copy: 'After appropriate evaluation, some adults may discuss a custom oral appliance as one treatment option.',
        steps: [
          ['Review the pattern', 'A clinician decides whether testing or another next step is appropriate.'],
          ['Discuss options', 'Your care team explains whether an appliance or another approach may fit.'],
          ['Plan follow-up', 'Care follows your evaluation, comfort, and treatment plan.'],
        ],
  ...
  },
  {
    ...
    headline: 'Snoring, tired mornings, and brain fog are worth noticing.',
    subheadline: 'Feeling tired can become routine. A short survey can help you decide whether a conversation is worth having.',
    hero: '/assets/images/symptom-v2.jpg', designSystem: 'morning-signal',
    recognitionTitle: 'Your symptoms may have a pattern.',
    recognitionIntro: 'You do not need to diagnose yourself. Tired mornings, snoring, and daytime fatigue can be useful patterns to discuss.',
    ...
    guidance: {
      reasons: {
        ...
        copy: 'It is easy to normalize fatigue, more coffee, or a noisy night. An evaluation can help clarify the next step.',
        cards: [
      ...
      appliance: {
        eyebrow: 'The right next step depends on you', title: 'Care begins with understanding the pattern.',
        copy: 'If evaluation identifies a sleep-related breathing concern, your care team can explain appropriate options. A custom oral appliance may be an option for some adults.',
        steps: [
          ['Share the pattern', 'Mention tired mornings, snoring, and partner-noticed changes.'],
          ['Complete evaluation', 'A qualified clinician determines what testing, if any, is needed.'],
          ['Choose a care path', 'Your team can discuss an appliance or another approach when appropriate.'],
        ],
  ...
  },
  {
    ...
    headline: 'When sleep is disrupted, both people feel it.',
    ...
    recognitionIntro: 'Snoring alone does not diagnose a condition. With gasping, pauses, or daytime tiredness, it can be worth learning more together.',
    ...
    guidance: {
      reasons: {
        ...
        copy: 'A partner may notice changes before you do. A respectful conversation can turn a frustrating night into useful information for a clinician.',
        cards: [
      ...
      appliance: {
        ...
        copy: 'After sleep testing and clinical assessment, some adults may discuss a custom oral appliance. Other care paths may be more appropriate for others.',
        steps: [
          ['Share the pattern', 'Tell a qualified clinician what you or your partner notice.'],
          ['Review evaluation', 'Testing and clinical assessment guide the next conversation.'],
          ['Discuss options', 'A team can explain whether an appliance or another option fits the plan.'],
        ],
  ...
  },
  {
    ...
    subheadline: 'These symptoms can have many causes. When they happen regularly, a short survey can help you decide whether evaluation is worth discussing.',
    hero: '/assets/images/symptom-v1.jpg', designSystem: 'sleep-check',
    recognitionTitle: 'Common patterns to notice.',
    recognitionIntro: 'Consider the full pattern—not only snoring. Recurring symptoms can be useful to discuss with a clinician.',
    ...
    guidance: {
      reasons: {
        ...
        copy: 'You may not remember every nighttime interruption. Fatigue, low focus, dry mouth, or a partner’s observations can still be useful information.',
        cards: [
      ...
      appliance: {
        eyebrow: 'If care is needed, it is personalized', title: 'An oral appliance is one possible option.',
        copy: 'After appropriate evaluation, some adults may discuss a custom oral appliance. The recommendation depends on the person and clinical findings.',
        steps: [
          ['Start with the survey', 'Describe the patterns you recognize.'],
          ['Discuss evaluation', 'A clinician can decide whether testing or another step is appropriate.'],
          ['Review options', 'If indicated, a qualified dentist can discuss an appliance and follow-up care.'],
        ],
  ...
  },
  {
    ...
    headline: 'A better sleep conversation starts with what you notice.',
    subheadline: 'If snoring, poor rest, or daytime fatigue affects daily life, start with a short survey and a local conversation when you are ready.',
    hero: '/assets/images/hero-v2.jpg', designSystem: 'local-care-calm-direction',
    recognitionTitle: 'A practical next step.',
    recognitionIntro: 'You do not have to know the cause or treatment. Start by sharing what you notice.',
    ...
    guidance: {
      reasons: {
        eyebrow: 'Local care, calm direction', title: 'Start with what you notice.',
        copy: 'Morning energy, a partner’s observations, and daytime alertness can help guide the next conversation.',
        cards: [
      ...
      appliance: {
        ...
        copy: 'When evaluation supports it, some adults may benefit from a custom oral appliance for sleep-related breathing care. Your care team can explain whether it is appropriate.',
        steps: [
          ['Share the pattern', 'Describe what you notice without trying to diagnose it yourself.'],
          ['Review findings', 'A qualified clinician determines the appropriate next step.'],
          ['Discuss options', 'An oral appliance or another approach may be considered when appropriate.'],
        ],
