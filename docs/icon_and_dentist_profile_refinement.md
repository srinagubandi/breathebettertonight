# Symptom Icons and About the Dentist — Two-Loop Refinement

## Scope

The public landing-page change replaces only the numbered symptom-recognition markers highlighted by the user. It preserves unrelated process-step numbering, which communicates a sequence rather than a symptom category. The new **About the Dentist** section appears only when both practice identity and the dedicated profile setting are enabled.
